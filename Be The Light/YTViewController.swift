...
class YTViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    var apiKey = "AIzaSyDwQzfyEE0e-TRMXVbZl0PLCOcV8AfDUII"
    
    var desiredChannelsArray = ["UCnKfUtSXnDUhZurR1e-w5Qw", "UC-qQ8alzvU7VL6rBtO63FIA"]
